...
class CsvFile implements Iterator, Countable
{
	 ...
	 * @throws \Exception
	 */
	public function __construct($filename, $headerRow = 0, $delimiter = ',',
								$enclosure = '"', $escape = '\\')
	{
	...
	public function rewind()
	{
		...
		{
			$this->headers = fgetcsv($this->_handle, 0, $this->_delimiter,
	...
	{
		$rowData = fgetcsv($this->_handle, $this->_maxLineLength,
	...
	public function next()
	{
		...
		{
			fgetcsv($this->_handle, $this->_maxLineLength, $this->_delimiter,
					$this->_enclosure, $this->_escape);
			$this->_fgetcsvPosition++;
		}
